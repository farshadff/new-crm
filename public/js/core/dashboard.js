...
var Dashboard = function () {
    ...
    var _TrafficSourcesStreamChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.csv('/js/core/traffic_sources.csv', function (error, data) {
    ...
    var _AppSalesLinesChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.csv('/js/core/app_sales.csv', function(error, data) {
                formatted = data;
                redraw();
            });
    ...
    var _AppSalesHeatmap = function(element) {
        ...
        if($(element).length > 0) {
            ...
            // Load data
            d3.csv('/js/core/app_sales_heatmap.csv', function(error, data) {
