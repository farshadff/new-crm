            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr class="border-double">
                        ...
                        <th scope="col">نام نمایشی نقش</th>
                    ...
                    @foreach($role_list as $roles)
                        <tr>
                            ...
                            <td><a href="/admin/products/{{$roles->id}}">{{$roles->name}}</a></td>
                            <td>{{$roles->title}}</td>
                            <td>
                                <div class="btn-group inline-display" role="group" aria-label="Basic example">
                                    <a  href="{{ URL::to('admin/products/' . $roles->id . '/edit') }}">
                                        <button type="button" class="btn btn-primary">ویراییش</button>
                                    </a>&nbsp;
                                    <form style="display: inline;" action="{{url('admin/products', [$roles->id])}}" method="POST">
