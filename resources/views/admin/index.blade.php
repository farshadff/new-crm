                            ...
                            <div class="col-lg-4">
                                <ul class="list-inline text-center">
                                    ...
                                    <li class="text-left">
                                        ...
                                        <div class="text-muted"><span class="status-mark border-success position-left"></span> 3 نفر</div>
                                    </li>
                                </ul>
                                ...
                                <div class="form-group">
                                    <select class="change-date select-sm" id="select_date">
                                        <optgroup label="<i class='icon-watch pull-right'></i> Time period">
                                            ...
                                            <option value="val4">خرداد 28 98</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </form>
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="content-group">
                                    <h5 class="text-semibold no-margin"><i class="icon-calendar5 position-left text-slate"></i> 500</h5>
                            ...
                            <div class="col-md-4">
                                <div class="content-group">
                                    <h5 class="text-semibold no-margin"><i class="icon-calendar52 position-left text-slate"></i> 568</h5>
                            ...
                            <div class="col-md-4">
                                <div class="content-group">
                                    <h5 class="text-semibold no-margin"><i class="icon-cash3 position-left text-slate"></i> 2000 تومان</h5>
